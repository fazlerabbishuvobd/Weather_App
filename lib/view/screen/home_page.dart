...
import 'package:weather_app/view/screen/search_city.dart';
import 'package:weather_app/view/screen/settings.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        body: FutureBuilder(
          future: Future.wait([
            ApiHelper().openApiWeather(lats: latitude ?? 50, lon: longitude ?? 50),
            ApiHelper().forecastTodayInfo(lats: latitude ?? 50, lon: longitude ?? 50),
            ApiHelper().forecastTomorrowInfo(lats: latitude ?? 50, lon: longitude ?? 50),
            ApiHelper().forecast10DayInfo(lats: latitude ?? 50, lon: longitude ?? 50),
          ]),
          builder:
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: TabBarView(
                          ...
                          children: [
                            ...
                            //Today
                            _buildTabBarTodayList(forecastTodayData, weatherData),

                            //Tomorrow
                            _buildTabBarTomorrowList(forecastTomorrowData),

                            //10 Days
                            _buildTabBar10daysList(forecast10DayData),
                          ],
                        ),
                      ),
                      ...
                      //<---------------- Sunrise & Sunset ------------------------>
                      _buildSunriseSunsets(weatherData),
                      SizedBox(
                        height: height * 0.02,
                      ),
                    ],
  ...
  Row _buildSunriseSunsets(Map<String, dynamic> weatherData) {
    return Row(
  ...
  Container _buildTabBar10daysList(Map<String, dynamic> forecast10DayData) {
    return Container(
      padding: const EdgeInsets.all(10),
  ...
  Container _buildTabBarTodayList(Map<String, dynamic> forecastTodayData, Map<String, dynamic> weatherData) {
    return Container(
      padding: const EdgeInsets.all(10),
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(15),
